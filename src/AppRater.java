...
//AppRater Source: 
//http://blog.zeezonline.com/2012/07/android-rate-my-app-dialog/
public class AppRater {
	   private final static String APP_TITLE = "Bill Splitter";     
	    private final static String APP_PACKAGE_NAME = "com.cslabs.billsplitter";
	    //App rate pop up appears after following requirements are met: 
	    ...
	    public static void showRateDialog(final Context mContext,
	        ...
	        String message = "If you have enjoyed using "
	                + "this app"
	                + ", please take a moment to rate it. Thank you for your support!";
